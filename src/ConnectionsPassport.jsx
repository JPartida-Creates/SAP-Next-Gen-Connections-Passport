...
const TIMEZONES = {
  ...
  Canada: "PT (UTC-8)", Brazil: "BRT (UTC-3)",
  UAE: "GST (UTC+4)", "Saudi Arabia": "AST (UTC+3)", "South Africa": "SAST (UTC+2)",
};

// Office-level timezone overrides (takes precedence over country-level)
...
// IANA timezone names — handles DST automatically
const COUNTRY_IANA = {
  ...
  "United States": "America/New_York", "Canada": "America/Vancouver",
...
const OFFICE_IANA = {
  ...
  "Newtown Square": "America/New_York",
};
              ...
              <div key={spinKey} className={spinning ? "" : "slot-card-enter"}>
                ...
                <div className="p-4 relative overflow-hidden">
                  <div className="flex items-start gap-3 mb-3 relative">
                    <Avatar name={suggestion.name} size={48} />
    ...
    return (
      <div className="border-b" style={{ borderColor: "#EAF5FF" }}>
        <div className="px-4 py-3 flex items-center gap-3">
          <Avatar name={other.name} size={32} />
          <div className="flex-1 min-w-0">
      ...
      <div className="rounded-3xl overflow-hidden w-full max-w-sm"
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-4 mb-5">
            <Avatar name={matchedUser.name} size={56} />
            <div>
